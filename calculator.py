...
button_mult = tkinter.Button(root, text="*", command=lambda: add("*"))
...
button_sub = tkinter.Button(root, text="-", command=lambda: add("-"))
...
button_decimal = tkinter.Button(root, text=".", command=lambda: add("."))
button_decimal.grid(row=4, column=2)
button_sum = tkinter.Button(root, text="+", command=lambda: add("+"))
